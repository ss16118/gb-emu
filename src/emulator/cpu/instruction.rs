...
pub static CB_REG_LOOKUP: Map<u8, RegType> = phf_map! {
    0x00_u8 => RegType::RT_B,
    0x01_u8 => RegType::RT_C,
    0x02_u8 => RegType::RT_D,
    0x03_u8 => RegType::RT_E,
    0x04_u8 => RegType::RT_H,
    0x05_u8 => RegType::RT_L,
    0x06_u8 => RegType::RT_HL,
    0x07_u8 => RegType::RT_A,
};
    ...
    pub fn disass(&self, cpu: &mut CPU) -> String {
        ...
        match self.addr_mode {
            ...
            AddrMode::AM_R_D8 |AddrMode::AM_R_A8 => {
                result.push_str(&format!("{},${:02X}", self.reg1.str(), cpu.fetched_data & 0xFF));
            },
            AddrMode::AM_R_MR => {
                result.push_str(&format!("{},({})", self.reg1.str(), self.reg2.str()));
            },
            ...
            AddrMode::AM_HLI_R => {
                result.push_str(&format!("(HL+),{}", self.reg2.str()));
            },
            AddrMode::AM_HLD_R => {
                result.push_str(&format!("(HL-),{}", self.reg2.str()));
            },
            AddrMode::AM_A8_R => {
                result.push_str(&format!("${:02X},{}", (cpu.mem_dest & 0xFF) as u8, self.reg2.str()));
            },
            AddrMode::AM_HL_SPR => {
...
pub static INSTRUCTIONS: Map<u8, Instruction> = phf_map! {
    ...
    0x07_u8 => Instruction::default(InstrType::IN_RLCA, AddrMode::AM_IMP),
    0x08_u8 => Instruction::with_two_regs(InstrType::IN_LD, AddrMode::AM_A16_R,
        RegType::RT_NONE, RegType::RT_SP),
    ...
    0x0F_u8 => Instruction::default(InstrType::IN_RRCA, AddrMode::AM_IMP),
    ...
    0x12_u8 => Instruction::with_two_regs(InstrType::IN_LD, AddrMode::AM_MR_R, RegType::RT_DE, RegType::RT_A),
    ...
    0x17_u8 => Instruction::default(InstrType::IN_RLA, AddrMode::AM_IMP),
    ...
    0x1F_u8 => Instruction::default(InstrType::IN_RRA, AddrMode::AM_IMP),
    ...
    0x27_u8 => Instruction::default(InstrType::IN_DAA, AddrMode::AM_IMP),
    ...
    0x36_u8 => Instruction::with_one_reg(InstrType::IN_LD, AddrMode::AM_MR_D8, RegType::RT_HL),
    0x37_u8 => Instruction::default(InstrType::IN_SCF, AddrMode::AM_IMP),
    ...
    // 0x80 - 0x8F
    0x80_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0x81_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0x82_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0x83_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0x84_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0x85_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0x86_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),
    0x87_u8 => Instruction::with_two_regs(InstrType::IN_ADD, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),
    0x88_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0x89_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0x8A_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0x8B_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0x8C_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0x8D_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0x8E_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),
    0x8F_u8 => Instruction::with_two_regs(InstrType::IN_ADC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),

    // 0x90 - 0x9F
    0x90_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0x91_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0x92_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0x93_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0x94_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0x95_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0x96_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),
    0x97_u8 => Instruction::with_two_regs(InstrType::IN_SUB, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),
    0x98_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0x99_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0x9A_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0x9B_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0x9C_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0x9D_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0x9E_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),
    0x9F_u8 => Instruction::with_two_regs(InstrType::IN_SBC, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),
    
    // 0xA0 - 0xAF
    0xA0_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0xA1_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0xA2_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0xA3_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0xA4_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0xA5_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0xA6_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),
    0xA7_u8 => Instruction::with_two_regs(InstrType::IN_AND, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),
    0xA8_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0xA9_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0xAA_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0xAB_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0xAC_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0xAD_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0xAE_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),
    0xAF_u8 => Instruction::with_two_regs(InstrType::IN_XOR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),

    // 0xB0 - 0xBF
    0xB0_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0xB1_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0xB2_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0xB3_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0xB4_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0xB5_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0xB6_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),
    0xB7_u8 => Instruction::with_two_regs(InstrType::IN_OR, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),
    0xB8_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_B),
    0xB9_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_C),
    0xBA_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_D),
    0xBB_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_E),
    0xBC_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_H),
    0xBD_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_L),
    0xBE_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_MR,
        RegType::RT_A, RegType::RT_HL),    
    0xBF_u8 => Instruction::with_two_regs(InstrType::IN_CP, AddrMode::AM_R_R,
        RegType::RT_A, RegType::RT_A),
    ...
    0xCA_u8 => Instruction::new(InstrType::IN_JP, AddrMode::AM_D16,
        RegType::RT_NONE, RegType::RT_NONE, CondType::CT_Z, 0),
    0xCC_u8 => Instruction::new(InstrType::IN_CALL, AddrMode::AM_D16,
        RegType::RT_NONE, RegType::RT_NONE, CondType::CT_Z, 0),
    ...
    0xD2_u8 => Instruction::new(InstrType::IN_JP, AddrMode::AM_D16,
        RegType::RT_NONE, RegType::RT_NONE, CondType::CT_NC, 0),
    0xD4_u8 => Instruction::new(InstrType::IN_CALL, AddrMode::AM_D16,
        RegType::RT_NONE, RegType::RT_NONE, CondType::CT_NC, 0),
    ...
    0xDA_u8 => Instruction::new(InstrType::IN_JP, AddrMode::AM_D16,
        RegType::RT_NONE, RegType::RT_NONE, CondType::CT_C, 0),
    0xDC_u8 => Instruction::new(InstrType::IN_CALL, AddrMode::AM_D16,
        RegType::RT_NONE, RegType::RT_NONE, CondType::CT_C, 0),
    ...
    // 0xF0 - 0xFF
    0xF0_u8 => Instruction::with_one_reg(InstrType::IN_LDH, AddrMode::AM_R_A8,
        RegType::RT_A),
    ...
    0xFA_u8 => Instruction::with_one_reg(InstrType::IN_LD, AddrMode::AM_R_A16,
        RegType::RT_A),
